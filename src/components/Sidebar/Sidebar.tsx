    ...
    return (
        <ul className="menu bg-base-200 menu-lg w-56 min-w-56 rounded-box fadeIn">
            ...
            <li className="dropdown dropdown-right mt-1">
                ...
                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-200/50 rounded-box w-50">
            ...
            <li className="dropdown dropdown-right mt-1">
                <a tabIndex={0} role="button" className="pl-5">
                    <img src="/assets/imgs/tools.svg" alt="tools" className="pr-1 filter brightness-75 w-9 h-9"/>
                    <div>Tools</div>
                </a>
                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-200/50 rounded-box w-50">
                    <li className="mt-1 first:mt-0"><NavLink to='/tools/normalizer'>Normalizer</NavLink></li>
                </ul>
            </li>
            <li className="mt-1">
                <NavLink to="/links">
